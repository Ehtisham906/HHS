...
export default function Expertise() {
    ...
    const headings = [
        ...
        <h1 className="text-center flex flex-col items-center" >
            ...
            Barbers</h1>,
        <h1 className="text-center flex flex-col items-center">
            <svg fill="currentcolor" height="62" width="62" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488.601 488.601" >
        ...
        <h1 className="text-center flex flex-col items-center">
            ...
            Plumbers</h1>,
        <h1 className="text-center flex flex-col items-center">
            <svg viewBox="0 0 100 100" height="62" width="62" data-name="Layer 1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" fill="currentcolor">
