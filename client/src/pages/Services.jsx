        ...
        <main>
            ...
            <div className='w-full flex justify-center mt-20'>
                ...
                <Link to={'/services-form'}>
                    <button className='border bg-secondary transition-transform duration-300 ease-in-out hover:scale-105 rounded-md p-4 text-3xl text-white'>Order Now</button>
                </Link>
            </div>
        </main>
    )
...
//     const [amount, setAmount] = useState(""); // Amount in ETH (not Wei)
...
//     const contractAddress = "0xb673c9ABA6Bbfb74314Fa773B5C1bCC15f79a5Fe";  // Replace this with actual deployed contract address
//     const contractABI = [
//         {
//             "inputs": [],
...
//                 // Load the contract
//                 const paymentContract = new web3Instance.eth.Contract(contractABI, contractAddress);
...
//     // Handle form submit (payment initialization)
//     const handlePayment = async (e) => {
//         e.preventDefault();

//         if (!contract || !amount || !web3) {
//             alert("Web3 is not initialized or amount is missing!");
//             return;
//         }

//         try {
//             // Ensure the amount entered is a valid number
...
//             console.log(`Sending ${amount} ETH, which is ${weiAmount} Wei`);

//             // Send the payment using the contract's function
//             await contract.methods.payForService().send({
//                 from: account,
//                 value: weiAmount, // Sending the converted amount in Wei
//             });

//             console.log("Payment successful");

//             // Automatically withdraw funds after payment
//             const receipt = await contract.methods.withdraw().send({
//                 from: account
//             });

//             console.log("Funds withdrawn successfully", receipt);
//             alert(`Payment of ${amount} ETH sent and funds withdrawn successfully!`);

//         } catch (error) {
//             console.error("Error processing payment:", error);
//             alert("Payment or withdrawal failed!");
//         }
//     };
