...
export default function Footer() {
    return (
        <footer className="bg-primary text-white mt-[60px]">
            <div className="flex justify-between footerSection" >
                

                <div className=" flex flex-col gap-3 sm:gap-10 contactDetails">
                    <div className="flex gap-3">
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} color={"#ffff"} fill={"none"}>
                                ...
                                <path d="M14 6.83185C15.4232 7.43624 16.5638 8.57677 17.1682 10M14.654 2C18.1912 3.02076 20.9791 5.80852 22 9.34563" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
                            </svg>
                        </div>

                        <div >
                            <span className="font-thin text-sm sm:font-normal">+923119211231</span>
                        </div>
                    </div>
                    <div className="flex gap-3">
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="#ffff">
                                <path fillRule="evenodd" clipRule="evenodd" d="M12 2C8.13 2 5 5.13 5 9C5 14.25 12 22 12 22C12 22 19 14.25 19 9C19 5.13 15.87 2 12 2ZM12 11.5C10.62 11.5 9.5 10.38 9.5 9C9.5 7.62 10.62 6.5 12 6.5C13.38 6.5 14.5 7.62 14.5 9C14.5 10.38 13.38 11.5 12 11.5Z" fill="#ffff" />
                            </svg>
                        </div>
                        <div>

                            <span className="font-thin text-sm sm:font-normal">Karakoram International University</span>
                        </div>
                    </div>
                    <div className="flex gap-3">
                        <div>
            ...
            <div className="flex justify-center">
                <div className="mx-auto">
                    ...
                    <span className="font-thin text-sm sm:font-normal">&#169; 2024 HSB</span>
                </div>
                <div className="mx-auto">

                    <span className="font-thin text-sm sm:font-normal">Privacy Policy</span>
                </div>
                <div className="mx-auto">

                    <span className="font-thin text-sm sm:font-normal">Terms of Services</span>
                </div>
            </div>
        </footer>
    )
